      ...
      <div className="sm:flex flex-wrap md:gap-2">
        {setPost.map((item, i) => (
          <div className="sm:flex" key={i}>
              ...
              <div
                className="mx-[10px] ml-[0px] sm:ml-[10px] px-[10px] w-[100%] sm:w-[200px] md:w-[260px] lg:w-[248px] xl:w-[330px]"
                // id={item.id}
              >
                <div className="group relative flex justify-center items-center shadow">
                  ...
                  <div className="absolute right-0 bottom-0 text-right bg-[#F5F5F5] w-full h-0 group-hover:h-[60%] overflow-hidden duration-300 ease-in-out">
                    <p className="my-[20px] text-[14px] text-black hover:text-[#767676] font-semibold cursor-pointer">
                      Add to wish list <FaHeart className="inline ml-[10px]" />
                    </p>
                    <p className="my-[20px] text-[14px] text-black hover:text-[#767676] font-semibold cursor-pointer">
                      Compare <LuRefreshCcw className="inline ml-[10px]" />
                    </p>
                    <p className="my-[20px] text-[14px] text-black hover:text-[#767676] font-semibold cursor-pointer" onClick={() =>handleAddToCart(item)}>
                      Add to cart
